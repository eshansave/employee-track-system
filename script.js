...
const api_url = "https://emptkdb.herokuapp.com/user"
...
function postData() {
	...
	data = {name: name, age: age, contact: contact, salary: salary, city: city,};
...
function putData() {
    ...
    var salary = document.getElementById("salary").value;
	var city = document.getElementById("city").value;
	data = {_id: _id, name: name, age: age, contact: contact, salary: salary, city: city,};
